...
export default function WhatsappHome() {
  return (
    <div className="h-[100vh] w-full dark:bg-dark_bg_4 select-none border-l dark:border-l-dark_border_2 border-b-[6px] border-b-green_2">
      {/*Container*/}
      <div className="-mt-1.5 w-full h-full flex flex-col gap-y-8 items-center justify-center">
        ...
        <div className="mt-1 text-center space-y-[12px]">
          ...
          <p className="text-sm dark:text-dark_text_3">
            ...
            <br />
            Use Workie Chat on up to 4 linked devices and 1 phone at the same time.
          </p>
        </div>
      </div>
    </div>
